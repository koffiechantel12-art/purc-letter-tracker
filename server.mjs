...
const sectors = ["Electricity Distribution", "Electricity Transmission", "Electricity Generation - Hydro", "Electricity Generation - Thermal", "Electricity Generation - Solar", "Electricity Generation - Other", "Water", "Natural Gas", "Government Agency", "Consumer / Public", "Internal PURC", "Other"];

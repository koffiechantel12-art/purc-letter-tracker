...
const providersBySector = {
  ...
  "Electricity Generation": ["VRA", "Bui Power Authority", "Sunon Asogli Power", "Cenpower Generation", "Karpowership Ghana", "AKSA Energy Ghana", "CENIT Energy", "BXC Solar", "Meinergy Ghana", "Genser Energy", "Independent Power Producer"],
  Water: ["Ghana Water"],
